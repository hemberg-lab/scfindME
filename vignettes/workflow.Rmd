...
```{r}
data <- readr::read_tsv("/lustre/scratch117/cellgen/team218/gp7/Micro-exons/Runs/Paper/single_cell/MicroExonator/Whippet/Quant/Single_Cell/Pseudo_bulks/pseudo_bulks.psi.tsv", col_names=TRUE, progress=show_progress())
...
```{r}
markers_Scnn1a <- cellTypeMarkers(index.above.z, "Tasic_2016.L4_Scnn1a")
markers_Scnn1a
```
